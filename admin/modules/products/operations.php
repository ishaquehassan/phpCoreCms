...
if(isset($_GET['task'])){
    ...
    if($task == "add"){
        ...
        if(checkPostRequired("catId","Category Is Required")){
            $error = true;
        }
        if(checkPostRequired("price","Price Is Required")){
            $error = true;
        }
        ...
        if($error){
            ...
            $insertId = insertDb($connection,$moduleConfigs['db_table'],array(
                ...
                $moduleConfigs['db_prefix']."catId" => $_POST['catId'],
                $moduleConfigs['db_prefix']."price" => $_POST['price'],
                $moduleConfigs['db_prefix']."discount" => $_POST['discount'],
                $moduleConfigs['db_prefix']."descp" => $_POST['descp']
